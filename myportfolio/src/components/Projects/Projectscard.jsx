...
const Projectscard = ({title,main}) => {
  return (
    <div className='p-3 md:p-6 flex flex-col w-80 bg-[#0c0e19] shadow-xl shadow-slate-900 rounded-2x1'>
      ...
      <div className='mt-2 p-2 md:p-4 flex gap-2 md:gap-4'>
        ...
        duration-300 hover:scale-105 font-semibold rounded-3x1 bg-[#465697]'>
            Demo
        </button>
